  ...
  return (
    <ModuleCard moduleId="TARGET" name="CURRENT ACTION">
      <div className="space-y-4">
        ...
        <div className="font-pixel font-pixel-render text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-text-primary shadow-industrial min-h-[120px] md:min-h-[160px] flex items-center justify-center text-center px-4 break-words leading-normal tracking-normal">
          {scrambledText}
        </div>
      </div>
    </ModuleCard>
